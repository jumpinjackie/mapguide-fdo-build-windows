...
cd /D C:\Workspace\fdo-4.2-rel
call setenvironment.bat x86_amd64
call build_thirdparty.bat -p=x64 -c=release -a=buildinstall -a=buildinstall -o=C:\Workspace\fdo-build\rel64
if not "%errorlevel%"=="0" goto error
call build.bat -p=x64 -c=release -a=buildinstall -a=buildinstall -o=C:\Workspace\fdo-build\rel64
if not "%errorlevel%"=="0" goto error
goto done
:error
